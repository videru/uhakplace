...
<table width="690" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td><table width="690" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="422"><table width="422" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="77" bgcolor="#FFFFFF" class="a_text_title" style="padding:5pt 2pt 2pt 5pt"><strong>총인원</strong></td>
              <td><?=$data['class']?></td>
            </tr>
            <tr>
              <td bgcolor="#BECCDD" height="1" colspan="2"></td>
            ...
            <tr>
              <td width="77" bgcolor="#FFFFFF" class="a_text_title" style="padding:5pt 2pt 2pt 5pt"><strong>연수일정</strong></td>
              <td><?=$data['gigan']?></td>
            </tr>
            <tr>
              <td bgcolor="#BECCDD" height="1" colspan="2"></td>
  ...
  <tr>
    <td><strong>2.간략소개/TIP</strong></td>
  </tr>
  <tr>
    <td><?=$data['info']?></td>
  </tr>
  ...
  <tr>
    <td><strong>3.수업내용 및 상세프로그램</strong></td>
  </tr>
  <tr>
    <td><?=$data['program']?></td>
  </tr>
  ...
  <tr>
    <td><strong>4.연수비용 상세안내</strong></td>
  </tr>
  <tr>

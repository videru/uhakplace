...
<table width="833" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    <td><img src="./img/ju_study.jpg"/></td>
  </tr>
  <tr>
    <td ><img src="./img/list_tab_top21.jpg"/></td>
  </tr>
  <tr>
    <td background="./img/list_tab_bg.gif">
     <table width="770" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#d1d1d1">
		<tr >
	      <td colspan="5" bgcolor="#FFFFFF"><img src="./img/list_title2.gif"></td>
		</tr>  
       <tr>
...
?>
        <tr bgcolor="#FFFFFF" height="35"> 
	      ...
	      <td width="470"><?=$R[title]?></td> 
	      <td width="80" align="center"><a href="#" onclick="window_open('../junior/ju_school_view.php?&num=<?=$R[num]?>&section=1','online','scrollbars=yes,width=740,height=750');"><img src="./img/btn_view.gif" border="0"></a></td> 
       ...
       <tr>
         <td height="2" colspan="5" bgcolor="#d1d1d1"></td>
        </tr>
<?}?>
   </table>	

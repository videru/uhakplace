...
<tr><td align="center">
<a href="<?=$_path['bbs']?>list_new.php?bbs_code=<?=$bbs_code?>&year=<?=$nextyear?>&month=<?=$nextmonth?>"> <span style="font-size:10pt;font-weight:bold;"><?=$nextmonth?>월</span></a> <span style="font-size:8pt;"><?=$nextyear?></span>
</td><tr>
	<tr>
		<td>

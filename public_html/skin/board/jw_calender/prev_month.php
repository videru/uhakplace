...
<tr><td align="center">
<a href="<?=$_path['bbs']?>list_new.php?bbs_code=<?=$bbs_code?>&year=<?=$prevyear?>&month=<?=$prevmonth?>"><span style="font-size:10pt;font-weight:bold;"><?=$prevmonth?>월</span></a> <span style="font-size:8pt;"><?=$prevyear?></span>
</td><tr>
	<tr>
		<td>

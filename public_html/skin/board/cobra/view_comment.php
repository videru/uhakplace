...
<? if($_bbs_auth['comment']) { // 코멘트 쓰기여부 ?>
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="0" width="692" style="border-top:1px solid #CCCCCC; border-bottom:1px solid #CCCCCC;" bgcolor="#f7f7f7">

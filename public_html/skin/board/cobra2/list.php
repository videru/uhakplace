<table width="668" cellspacing="0" border="0" cellpadding="0">
...
<table border="0" cellpadding="0" cellspacing="0" width="668" onmouseover="list_over_color(event,'#FFFBFB',1)" onmouseout='list_out_color(event)'  align="center">
	...
	<tr>
		<td align="center" >
			<table width="668" border="0" cellpadding="0" cellspacing="0" >
                <tr>
					<td>
						<table width="630" cellspacing="0" border="0" cellpadding="0" align="center">
						...
						<?=$_post_param[0]?>
							<tr> 
								...
								<td background="<?=$skin_url?>images/searchbg.gif">&nbsp;
									...
									<input name="kw" type="text" id="kw" value="<?=$kw?>" size="14" hname="검색어" style="border:0px;width:220px;height:18px;background-image:url('<?=$skin_url?>images/search_form.gif');" required>

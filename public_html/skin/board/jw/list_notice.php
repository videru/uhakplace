...
<tr><td colspan="4" height="10" bgColor="#f0f0f0" ></td></tr>
<TR bgColor="#f0f0f0" height="78">
  <td>
    <table width="%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td colspan="4" align="left" style="padding: 0 0 2px 4px"><img src="<?=$skin_url?>images/list_notice.gif" align="absmiddle"><? if($_bbs_auth['cart']) { ?><input type=checkbox name="chk_nums[]" value="<?=$bd_num?>" class=none><? } ?> <?=$i_reply?> <?=$i_secret?> <a href="<?=$view_url?>"><span class="tt5"><strong><?=$bd_subject?></strong></span></a> <?=$i_comment_count?> <?=$i_new?></td>
      </tr>

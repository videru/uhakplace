...
?>
        <tr bgcolor="#FFFFFF" height="35"> 
	      ...
	      <td width="72" align="center"><a href="#" onclick="window_open('../junior/ju_school_view.php?&num=<?=$R[num]?>&section=1','online','scrollbars=yes,width=740,height=750');"><img src="./img/btn_view.gif" border="0"></a></td> 

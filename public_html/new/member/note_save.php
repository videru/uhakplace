...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td height="28" bgcolor="#F4FAFB">&nbsp;&nbsp;받은쪽지함</td>
			</tr>
			<tr>
...
?>
			<tr height="25">
				...
				<td align="center"><?=(($nt_type=='1')?"보낸쪽지":'받은쪽지')?></td>
				<td><a href="javascript:note_view('<?=$_url['member']?>','save','<?=$nt_num?>')"><?=rg_get_text($nt_content)?></a></td>

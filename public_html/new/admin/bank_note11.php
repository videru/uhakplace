<?
   ...
   // 접근 가능 등급 표시
	...
	$rs_list->add_where("comm_date1 = $date1 and comm_date2 = $date2 and student_no <>0");		
	$rs_list->add_group("student_no");		
    /***********************************************************************/
   // 필터 조건에 의한 필터링
...
<table width="770" border="0" cellpadding="0" cellspacing="0" align=center>
  <tr bgcolor="#456285"> 
	<td width="25" align="center" rowspan="3" class="tt6">NO</td>	
	<td width="40" align="center" rowspan="3" class="tt6">삭제</td>   
 	<td width="50" align="center" rowspan="3" class="tt6">등록일</td>   
	<td width="40" align="center" rowspan="3" class="tt6">지사</td>
	<td width="110" align="center" rowspan="3" class="tt6">입출금내역</td>	
	<td width="120" align="center" colspan="2" class="tt6">학생</td>
	<td width="120" align="center" colspan="2" class="tt6">기타</td> 
	<td width="60" align="center" rowspan="3" class="tt6">고정비용</td>
	<td width="60" align="center" rowspan="3" class="tt6">잔고</td>
	<td width="145" align="center" rowspan="3" class="tt6">비고</td>
  </tr>   
    <tr>
    <td bgcolor="#BECCDD" height="1" colspan="4"></td>
  </tr>
  <tr bgcolor="#456285">
	<td width="70" align="center" class="tt6">입금금액</td>
	<td width="70" align="center" class="tt6">지출금액</td>
	<td width="70" align="center" class="tt6">입금금액</td>
	<td width="70" align="center" class="tt6">지출금액</td>
  </tr>  
  ...
  <?
    ...
    $total_tt3 = $total_tt3 + $ttt3 ;
    $total_tt4 = $total_tt4 + $ttt4 ;
    $total_tt5 = $total_tt5 + $ttt5 ;

    $total_ttprice = $total_ttprice + ($ttt1+$ttt3-$ttt2-$ttt4-$ttt5);
...
<td align="center" class="tt5"><a href=account_del_ok.php?no=<?=$R[ac_no]?>&student_no=<?=$R[student_no]?>&comm_text_no=<?=$R[comm_text_no]?>&in_out_comm=<?=$R[in_out_comm]?>&date1=<?=$date1?>&date2=<?=$date2?>><img src=images/sbt_del.gif border="0"></a></td>
    ...
    <td align="center" class="tt5"><font color="blue"><?=$com3?></font></td>		
    <td align="center" class="tt5"><font color="red"><?=$com4?></font></td>
    <td align="center" class="tt5"><font color="red"><?=$com5?></font></td>
...
<?}?>
  ...
  <tr bgcolor="#FFFFFF" height="25"> 
    ...
    <td align="center" class="tt5"><font color="blue"><?=number_format($total_tt3)?></font></td>		
    <td align="center" class="tt5"><font color="red"><?=number_format($total_tt4)?></font></td>
    <td align="center" class="tt5"><font color="red"><?=number_format($total_tt5)?></font></td>
    <td align="center" class="tt5"><?=number_format($total_ttprice)?></td>

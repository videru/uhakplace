...
<table border="0" cellpadding="0" cellspacing="0" width="800" align="center">
  <tr height="40">
    <td background="images/title_bg.gif" style="padding:9pt 0pt 0pt 10pt" valign="top"><font color=#000000><b>출국자관리</b></font></td>
  </tr>
</table>
<br>
...
<?=rg_html_option($_const['national'],"$ss[1]")?>
			...
			이름 <input name="kw" type="text" id="kw" value="<?=$kw?>" size="25" class="cc"></td>
  </tr>
  <tr> 
    <td background="images/search_bg_middle.gif" align="center"><img src=images/icon_line.gif border="0"></td>
  </tr>
  <tr> 
    <td background="images/search_bg_middle.gif" style="padding:0pt 0pt 0pt 15pt"><INPUT onfocus=this.blur() type=image src="images/bt_order_search.gif"></td>
  </tr>
  <tr> 
...
?>
  <tr height="30" bgcolor=<?=$fontcolor?>> 
	...
	<td align="center" class="tt5"><a href="regi_edit.php?<?=$p_str?>&page=<?=$page?>&mode=modify&num=<?=$R[regi_no]?>&pp=1"><img src=images/sbt_modify.gif border="0"></a></td>
	<td align="center" class="tt5"><a href="regi_edit.php?<?=$p_str?>&page=<?=$page?>&mode=delete&num=<?=$R[regi_no]?>&pp=1"><img src=images/sbt_del.gif border="0"></a></td>
    <td align="center" class="tt5"><?=$R[student_name]?></td>	
    <td align="center" class="tt5"><?=$_regi['chain'][$R[chain]]?></td>
    <td align="center" class="tt5"><?=$R[regi_date1]?>.<?=$R[regi_date2]?>.<?=$R[regi_date3]?></td>	
    <td align="center" class="tt5"><?=$R[abroad_date1]?>.<?=$R[abroad_date2]?>.<?=$R[abroad_date3]?></td>	

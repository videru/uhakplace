	...
	function makeCal(){
		...
		bodyCode += "        </tr>";
		bodyCode += "        <tr align=center>";
		bodyCode += "          <td colspan=3> 오늘 : " + (today.getMonth() + 1) +"월 " + today.getDate() + "일 " + day_header[today.getDay()] + "요일</td>";
		bodyCode += "        </tr>";
		bodyCode += "        <tr align=center>";
		bodyCode += "          <td colspan=3> <b><a href='javascript:hide();' style='COLOR: #000066; TEXT-DECORATION: none'> [닫기] </a></b> </td>";
		bodyCode += "        </tr>";
		bodyCode += "      </table>";
		bodyCode += "    </td>";
		bodyCode += "  </tr>";

					...
					<td>
						<table width="100%" cellpadding="3" >
							<tr height="50px">
								...
								<td>
									<textarea name="bc_content" cols="60" rows="3" style="width:100%" class="input" required hname="내용"></textarea>
								</td>
...
<? if($vcfg['input_name'] || $vcfg['spam_chk']) { ?>
				<tr>
					<td style="padding-left:30px;">
							<? if($vcfg['input_name']) {?>
							작성자  <input type="text" name="bc_name" value="" class="input" required hname="작성자">&nbsp;&nbsp;

...
/* =====================================================
 ...
 ===================================================== */
	...
	while($tmp=$rs->fetch()) {
		...
		$data[$tmp['dd']]['counter']=$tmp['counter'];
		$data[$tmp['dd']]['counter2']=$tmp['counter2'];
	}
...
<?
	for($i=1;$i<=date('t',mktime(0,0,0,$mm,1,$yy));$i++) {
		$ww=$weeks[date('w',mktime(0,0,0,$mm,$i,$yy))];
		$w_color='black';
...
?>
  <tr> 
    ...
    <td align="center"><font color='<?=$w_color?>'><?=$ww?></font></td>

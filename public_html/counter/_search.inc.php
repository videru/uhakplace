...
<input type="button" value="새로고침" onclick="location.reload()" />
    ...
    <td><a href="?type=search"><?=(($type2=='')?'<b>':'')?>[전체]<?=(($type2=='')?'</b>':'')?></a>  <a href="?type=search&type2=name"><?=(($type2=='name')?'<b>':'')?>[검색엔진별]<?=(($type2=='name')?'</b>':'')?></a>  <a href="?type=search&type2=keyword"><?=(($type2=='keyword')?'<b>':'')?>[키워드별]<?=(($type2=='keyword')?'</b>':'')?></a></td>
		<td>&nbsp;</td>
	</tr>
</table>

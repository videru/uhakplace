...
-->
								...
								<script language = "javascript">
                                	...
                                	scroll_content[0] = "<table width=100% cellpadding=0 cellspacing=0><tr><td width=75><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[0]?> target=_parent><img src=../img/banner/movie1.gif width=70 height=50 border=0></a></td><td><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[0]?> target=_parent><?=$Ktitle[0]?> <font color=blue>[<?=$Kcomment[0]?>]</font></a></td></tr></table>";
                                	scroll_content[1] = "<table width=100% cellpadding=0 cellspacing=0><tr><td width=75><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[1]?> target=_parent><img src=../img/banner/movie2.gif width=70 height=50 border=0></a></td><td><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[1]?> target=_parent><?=$Ktitle[1]?>  <font color=blue>[<?=$Kcomment[1]?>]</font></a></td></tr></table>";
                                	scroll_content[2] = "<table width=100% cellpadding=0 cellspacing=0><tr><td width=75><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[2]?> target=_parent><img src=../img/banner/movie3.gif width=70 height=50 border=0></a></td><td><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[2]?> target=_parent><?=$Ktitle[2]?>  <font color=blue>[<?=$Kcomment[2]?>]</font></a></td></tr></table>";
                                    scroll_content[3] = "<table width=100% cellpadding=0 cellspacing=0><tr><td width=75><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[3]?> target=_parent><img src=../img/banner/movie4.gif width=70 height=50 border=0></a></td><td><a href=../board/view.php?bbs_code=interview&bd_num=<?=$Kidx[3]?> target=_parent><?=$Ktitle[3]?>  <font color=blue>[<?=$Kcomment[3]?>]</font></a></td></tr></table>";
								</script>

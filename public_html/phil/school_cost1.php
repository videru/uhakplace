...
<table width="280" border="0" cellpadding="0" cellspacing="0" >
  <tr >   
    <td><input name="button3" type=button class=button onclick="open_window('fr','school_cost_sch.php?page_no=1', 80, 250, 440, 185, 0, 0, 0, 0, 0);" value='연수비용 견적'></td>
  </tr >
</table>
<br>
<table width="280" border="0" cellspacing="1" cellpadding="1" bgcolor="#cccccc">
  ...
  <tr height="22">
    ...
    <td bgcolor="#FFFFFF" class="tit"><?if($week){?><?=number_format($electcost_fee)?>원<?}?></td>
  </tr>
  <?}?>
  <tr height="22">

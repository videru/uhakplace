...
<table border="0" cellpadding="0" cellspacing="0" width="800" align="center">
  <tr height="40">
    <td background="images/title_bg.gif" style="padding:9pt 0pt 0pt 10pt" valign="top"><font color=#000000><b>1:1맞춤컨설팅</b></font></td>
  </tr>
</table>
<br>
...
<table width="770" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr bgcolor="#456285" height="25"> 
	...
	<td width="140" align="center" class="tt6">이메일</td>
	<td width="90" align="center" class="tt6">전화</td>
	<td width="90" align="center" class="tt6">핸드폰</td>
	<td width="220" align="center" class="tt6">메모</td>
...
?>
  <tr height="30" > 
	...
	<td align="center" class="tt5"><a href="consult_edit.php?process2=2&name=<?=$R[name]?>&email=<?=$R[email]?>&hp=<?=$R[hp]?>&num=<?=$R[num]?>">상담완료</a></td>

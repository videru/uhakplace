...
<table border="0" cellpadding="0" cellspacing="0" width="770" align=center>
	...
	<tr height="30">
		...
		<td width="75"><select name="national" id="national" class="select">

<?=rg_html_option($_const['national'],$data["national"])?>

		</select>
		</td>
		<td width="260"><input name="text" type="text" class="cc" size=40></td>
...
<input type="hidden" name="num" value="<?=$R[num]?>" />
	<tr height="30">
		...
		<td width="75"><select name="national" id="national" class="select">
<?=rg_html_option($_const['national'],$R["national"])?>
		</select></td>
		<td  width="260"><input name="text" type="text" value="<?=$R["text"]?>" class="cc" size=40></td>

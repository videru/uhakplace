<?
	...
	$rs_list->clear();
	$rs_list->set_table($_table['intern']);
...
</select>&nbsp;&nbsp;&nbsp;학교이름 <input name="kw" type="text" id="kw" value="<?=$kw?>" size="30" class="cc">&nbsp;&nbsp;&nbsp;<INPUT onfocus=this.blur() type=image src="images/bt_order_search.gif" align="absmiddle">&nbsp;&nbsp;&nbsp;<a href="intern_edit.php?<?=$p_str?>&page=<?=$page?>&mode=new"><img src=images/school_regi.gif border="0" align="absmiddle"></a></td>
  </tr>
  <tr> 
...
?>
  <tr bgcolor="#FFFFFF" height="25"> 
	...
	<td align="center" class="tt5"><a href="intern_edit.php?<?=$p_str?>&page=<?=$page?>&mode=modify&num=<?=$R[num]?>&national=<?=$R[national]?>"><img src=images/sbt_modify.gif border="0"></a></td>
	<td align="center" class="tt5"><a href="#" onClick="confirm_del('intern_edit.php?<?=$p_str?>&page=<?=$page?>&mode=delete&num=<?=$R[num]?>&national=<?=$R[national]?>')"><img src=images/sbt_del.gif border="0"></a></td>

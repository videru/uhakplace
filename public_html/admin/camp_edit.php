...
<tr >
  ...
  <tr >
	<td bgcolor="#FFFFFF" class="a_text_title" style="padding:5pt 2pt 2pt 5pt"><strong>주관/주최</strong></td>
...
<?if($national == 3){?>
  ...
  <tr>
	<td colspan="4" style="padding:15 0 10 5"><strong>1.캠프개요</strong> <img src="./images/sc_more.gif"  align="absmiddle" style="CURSOR: hand" onmouseout="dismenu_0.display='none';" onclick="dnum(0);"  alt=""></td>
  </tr>
  <tr>
	<td bgcolor="#BECCDD" height="2" colspan="4"></td>
  </tr>
  ...
  <table width="100%" cellpadding="0" cellspacing="0">    
   ...
   <tr>
	<td bgcolor="#FFFFFF" class="a_text_title" style="padding:5pt 2pt 2pt 5pt"><strong>캠프구분</strong></td>
  ...
  <tr>
	<td width="130" bgcolor="#FFFFFF" class="a_text_title" style="padding:5pt 2pt 2pt 5pt"><strong>영어외수업</strong></td>
  ...
  <tr>
	<td colspan="4" style="padding:15 0 10 5"><strong>2.캠프요강</strong> <img src="./images/sc_more.gif"  align="absmiddle" style="CURSOR: hand" onmouseout="dismenu_1.display='none';" onclick="dnum(1);"  alt=""></td>
  </tr>
  <tr>
	<td bgcolor="#BECCDD" height="2" colspan="4"></td>
  </tr>
  ...
  <tr>
	<td colspan="4" style="padding:15 0 10 5"><strong>3.간락특징/TIP</strong> <img src="./images/sc_more.gif"  align="absmiddle" style="CURSOR: hand" onmouseout="dismenu_2.display='none';" onclick="dnum(2);"  alt=""></td>
  </tr>
  <tr>
	<td bgcolor="#BECCDD" height="2" colspan="4"></td>
  </tr>
  ...
  <tr>
	<td colspan="4" style="padding:15 0 10 5"><strong>4.수업내용 및 상세프로그램</strong>  <img src="./images/sc_more.gif"  align="absmiddle" style="CURSOR: hand" onmouseout="dismenu_3.display='none';" onclick="dnum(3);"  alt=""></td>
  </tr>
  <tr>
	<td bgcolor="#BECCDD" height="2" colspan="4"></td>
  </tr>  
  ...
  <tr>
	<td colspan="4" style="padding:15 0 10 5"><strong>5.Activity소개</strong>  <img src="./images/sc_more.gif"  align="absmiddle" style="CURSOR: hand" onmouseout="dismenu_4.display='none';" onclick="dnum(4);"  alt=""></td>
  </tr>
  <tr>
	<td bgcolor="#BECCDD" height="2" colspan="4"></td>
  </tr>
 <tr>
  ...
  <tr>
	<td colspan="4" style="padding:15 0 10 5"><strong>6.연수비용 상세안내</strong>  <img src="./images/sc_more.gif"  align="absmiddle" style="CURSOR: hand" onmouseout="dismenu_5.display='none';" onclick="dnum(5);"  alt=""></td>
  </tr>
  <tr>
	<td bgcolor="#BECCDD" height="2" colspan="4"></td>
  </tr>
...
<? for ($i=2; $i<=9; $i++){?>
   <tr>
	...
	<td colspan="4" class="a_s_text_title">	<input name='school_file<?=$i?>' type=file class=cc style='width:40%;'>   &nbsp;&nbsp;                     
                         ...
                         <img src="../data/camp/<?=$num?>/<?=$data[school_file.$i._name]?>" width="60" height="40" align="absmiddle"> <input name='del_file<?=$i?>' type=checkbox id="del_file<?=$i?>" value='1'>삭제 
                          <?}?>
	</td>
  </tr>
<?}?>

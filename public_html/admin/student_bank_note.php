...
<?if($_mb[mb_level] == 90){?>
  ...
  <?
	...
	while($R=$rs_list->fetch()) {
	    ...
	    $total_iphak_in = $R[iphak_incomm] ;
	    $total_iphak_out = $R[iphak_outcomm] ;
	    $total_iphak_inout = $total_iphak_in - $total_iphak_out ;

	    $total_cost_in = $R[cost_incomm]+$R[cost_comm_incomm] ;
	    $total_cost_out = $R[cost_outcomm]+$R[cost_comm_outcomm] ;
	    $total_cost_inout = $total_cost_in - $total_cost_out ;

	    $total_dorm_in = $R[dorm_incomm] ;
	    $total_dorm_out = $R[dorm_outcomm] ;
	    $total_dorm_inout = $total_dorm_in - $total_dorm_out ;

	    $total_airfee_in = $R[airfee_incomm] ;
	    $total_airfee_out = $R[airfee_outcomm] ;
	    $total_airfee_inout = $total_airfee_in - $total_airfee_out ;

	    $total_insu_in = $R[insu_incomm] ;
	    $total_insu_out = $R[insu_outcomm] ;
	    $total_insu_inout = $total_insu_in - $total_insu_out ;


	    $total_etc_in = $R[hs_info_incomm]+$R[pickup_incomm]+$R[etc1_incomm]+$R[etc2_incomm] ;
	    $total_etc_out = $R[hs_info_outcomm]+$R[pickup_outcomm]+$R[etc1_outcomm]+$R[etc2_outcomm] ;
	    $total_etc_inout = $total_etc_in - $total_etc_out ;



       $total = $total_iphak_inout+$total_cost_inout+$total_dorm_inout+$total_airfee_inout+$total_insu_inout+$total_etc_inout ;
...
<table width="770" border="0" cellpadding="0" cellspacing="1" align="center" bgcolor="#B0B0B0"> 
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td class="tt5"><?=number_format($total_iphak_in)?></td>
    <td class="tt5"><?=number_format($total_iphak_out)?></td>
    <td class="tt5"><?=number_format($total_iphak_inout)?></td>
    <td class="tt5"><?=number_format($total_cost_in)?></td>
    <td class="tt5"><?=number_format($total_cost_out)?></td>
    <td class="tt5"><?=number_format($total_cost_inout)?></td>
    <td class="tt5"><?=number_format($total_dorm_out)?></td>
    <td class="tt5"><?=number_format($total_dorm_out)?></td>		
    <td class="tt5"><?=number_format($total_dorm_inout)?></td>
    <td rowspan="4" class="tt5"><?=number_format($total)?></td>
  </tr>
  <tr bgcolor="#DFDFDF"> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td align="center" class="tt5"><?=number_format($total_airfee_in)?></td>
    <td align="center" class="tt5"><?=number_format($total_airfee_out)?></td>		
    <td align="center" class="tt5"><?=number_format($total_airfee_inout)?></td>
    <td align="center" class="tt5"><?=number_format($total_insu_in)?></td>
    <td align="center" class="tt5"><?=number_format($total_insu_out)?></td>	
    <td align="center" class="tt5"><?=number_format($total_insu_inout)?></td>
    <td align="center" class="tt5"><?=number_format($total_etc_in)?></td>		
    <td align="center" class="tt5"><?=number_format($total_etc_out)?></td>
    <td align="center" class="tt5"><?=number_format($total_etc_inout)?></td>
  </tr>
</table>

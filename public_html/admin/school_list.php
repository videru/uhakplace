...
<table width="770" border="0" cellspacing="0" cellpadding="0" align="center">
 <form name="search_form" method="get" enctype="multipart/form-data">  
  <?
	$rs_ex = new $rs_class($dbcon);
	$rs_ex->clear();
	$rs_ex->set_table($_table['exchange']); 
    $ex=$rs_ex->fetch();	
...
?> 
  ...
  <tr> 
    <td background="images/search_bg_middle.gif" style="padding:0pt 0pt 0pt 15pt" class="tt4">[유로:<?=$ex[exchange1]?>]&nbsp;&nbsp;[미국:<?=$ex[exchange3]?>(USD)]&nbsp;&nbsp;[영국:<?=$ex[exchange4]?>(파운드)]&nbsp;&nbsp;[일본:<?=$ex[exchange5]?>(엔)]&nbsp;&nbsp;[캐나다:<?=$ex[exchange7]?>(CAD)]&nbsp;&nbsp;[호주:<?=$ex[exchange8]?>(AUD)]&nbsp;&nbsp;&nbsp;<a href="javascript:open_window('exchange', 'exchange_edit.php?mode=modify', 80, 120, 550, 400, 0, 0, 0, 0, 0);")><img src=images/exchange_regi.gif border="0" align="absmiddle"></a></td>
  </tr>
   <tr> 
...
</select>&nbsp;&nbsp;&nbsp;학교이름 <input name="kw" type="text" id="kw" value="<?=$kw?>" size="30" class="cc">&nbsp;&nbsp;&nbsp;<INPUT onfocus=this.blur() type=image src="images/bt_order_search.gif" align="absmiddle">&nbsp;&nbsp;&nbsp;<a href="school_edit.php?<?=$p_str?>&page=<?=$page?>&mode=new"><img src=images/school_regi.gif border="0" align="absmiddle"></a></td>
  </tr>
  <tr> 
...
?>
  <tr bgcolor="#FFFFFF" height="25"> 
	...
	<td align="center" class="tt5"><a href="school_edit.php?<?=$p_str?>&page=<?=$page?>&mode=modify&num=<?=$R[num]?>&national=<?=$R[national]?>"><img src=images/sbt_modify.gif border="0"></a></td>
	<td align="center" class="tt5"><a href="#" onClick="confirm_del('school_edit.php?<?=$p_str?>&page=<?=$page?>&mode=delete&num=<?=$R[num]?>&national=<?=$R[national]?>')"><img src=images/sbt_del.gif border="0"></a></td>
	...
	<td align="center" class="tt5"><?=$_const['section'][$R[section]]?></td>

...
<tr><td align="center">
<a href="consult_list.php?&year=<?=$prevyear?>&month=<?=$prevmonth?>"><span style="font-size:10pt;font-weight:bold;"><?=$prevmonth?>월</span></a> <span style="font-size:8pt;"><?=$prevyear?></span>
</td><tr>
	<tr>
		<td>
								...
								<?
									...
									for($day=1;$day<=$total_day;$day++){
										...
										if($cal=$cal_list->fetch()){
											echo "<A HREF='consult_edit.php?&c_no={$cal[c_no]}&year=$prevyear&month=$prevmonth' title='$cal[bd_subject]'><b><u><span style=' color:$day_color;'>$day</span></u></b></a></td>" ;
										} else {

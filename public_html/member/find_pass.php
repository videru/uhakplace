...
※ 암호가 변경되어 전송되기 때문에 이메일을 확인후 변경된 암호로 로그인 하셔야 합니다.
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center"><input type="button" class="button" value=" 회원가입 " onClick="location.href='<?=$_path['member']?>join.php'">
				  <input type="button" class="button" value=" 암호찾기 " onClick="location.href='<?=$_path['member']?>find_pass.php'">					</td>
			</tr>
		</table>
		</form>		</td>
	</tr>
...
<table width="300" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="center"><input type="button" class="button" value=" 회원가입 " onClick="location.href='<?=$_path['member']?>join.php'">
				  <input type="button" class="button" value=" 아이디찾기 " onClick="location.href='<?=$_path['member']?>find_id.php'">					</td>
			</tr>
		</table>
		</form>		</td>
	</tr>

...
<table border="0" cellpadding="8" cellspacing="5" width="100%" height="100%" bgcolor="#E6E8EB">
	...
	<tr>
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed">
									<tr>
										<td>
										<input type="file" name="upfile" id="upfile" onchange="imgview(1);" class="input">
										</td>
									</tr>
								</table>
								</td>
							...
							<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td>
										<input type="text" name="link" id="link" style="width: 95%" onchange="imgview(0);" class="input">
										</td>
									</tr>
								</table>
								</td>
							...
							<tr>
								...
								<td width="97">
								<input type="text" name="imgsize" size="4" class="input"> px
								</td>
								<td width="42">
				...
				<table border="1" cellpadding="6" cellspacing="0" width="99%" bordercolor="#CCCCCC" bordercolordark="white" bordercolorlight="black">
					<tr>
						...
						<img name="Pickimg" src="" onerror="this.style.display='none';">
						</td></tr>
						</table>
						</td>
					</tr>
			...
			<tr>
			<td align=center>
			<script>document.write('<input type="submit" value=" ' + editor_lang[32] + ' " class="input"> &nbsp;<input type="button" value=" ' + editor_lang[33] + ' " onclick="window.close()" class=input>');</script>
			</td>
		</tr>
		</table>
		</td>
